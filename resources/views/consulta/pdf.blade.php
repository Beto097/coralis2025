...
<body>
  <div class="pagina">
    <div>    
      <p id="nRegistro" style="padding-top: 112px; padding-left: 428px;">N° {{$consulta->numeroReceta()}}</p>
    </div>
    <div>
    ...
    <div style="margin-top: 0px; padding-left: 100px;">
        @foreach ($consulta->recetas as $receta)
            <p style="margin-top: 0px; padding-left:0px;">#{{$receta->cantidad}} {{$receta->medicamento}} {{$receta->dosis}} {{$receta->tratamiento}}</p>
        @endforeach
