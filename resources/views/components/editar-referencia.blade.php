...
<div class="row" style="padding-top: 15px">      
    ...
    <div class="form-group col-md-12">
        ...
        <textarea class="form-control" name="txtAmammensia" id="txtAnamnesiaEdit" rows="3" required>{{ $datos['txtAmammensia'] ?? '' }}</textarea>        
    </div>
    <div class="form-group col-md-12">
        <label for="">Examen Fisico: <span class="text-danger">*</span></label>
        <textarea class="form-control" name="txtExamenFisico" id="txtExamenFisicoEdit" rows="3" required>{{ $datos['txtExamenFisico'] ?? '' }}</textarea>        
    </div>
    <div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
        ...
        <textarea class="form-control" name="txtDiagnostico" id="txtDiagnosticoEdit" rows="3" required>{{ $datos['txtDiagnostico'] ?? '' }}</textarea>        
    </div>
    <div class="form-group col-md-12">
        <label for="">Tratamiento y Complicaciones: <span class="text-danger">*</span></label>
        <textarea class="form-control" name="txtTratamiento" id="txtTratamientoEdit" rows="3" required>{{ $datos['txtTratamiento'] ?? '' }}</textarea>        
    </div>

    <script>
        document.getElementById('motivoREdit').addEventListener('change', function() {
        ...
        document.getElementById('btnEditarModal').addEventListener('click', function(e) {
