<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="editarMedicoModal<?php echo e($fila->id); ?>"  aria-hidden="true" style="display: none;">
            ...
            <div class="modal-body">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="<?php echo e(route('medico.save')); ?>" method="POST" role="form" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputEmail4" placeholder="Ejemplo:Juan" name="txtNombre"
                                            value="<?php echo e($fila->nombre_medico); ?>" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtRegistro4" placeholder="Ejemplo:1538540" 
                                            value="<?php echo e($fila->numero_registro); ?>" name="txtNumero" required>                            
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <label class="control-label mb-10">Correo</label>
                                        <div class="input-group mb-15"> <span class="input-group-addon">@</span>
                                            <input type="email" value="<?php echo e($fila->email_medico); ?>" placeholder="Ejemplo:juan@gmail.com" name="txtEmail" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="input-group mb-15"> <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                            <input type="text" class="form-control" value="<?php echo e($fila->telefono_medico); ?>" placeholder="Ejemplo:64987858" aria-describedby="addon-wrapping"
                                            name="txtTelefono">
                                        </div>
                                    </div>
                                </div>
...
<?php /**PATH D:\Escritorio\Importante\Clientes\clinica nueva\clinicaNueva\resources\views/modals/editarMedicoModals.blade.php ENDPATH**/ ?>