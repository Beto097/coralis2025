...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
          <?php if(Auth::user()->accesoRuta('/rol/create')): ?>
            ...
            <?php echo $__env->make('modals.RolModals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>  
                                    ...
                                    <tbody>
                                      <?php $__currentLoopData = $resultado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="font-size: 100%;">
                                          ...
                                          <td><?php echo e($fila->nombre_rol); ?></td>                                                               
                                          <td>
                                            
                                            
              
                                            <?php if(Auth::user()->accesoRuta('/rol/update')): ?>
                                            
                                              <button type="button" class="btn btn-success btn-sm" id="editRol"                
                                                  data-toggle="modal" data-target="#editarRolModal<?php echo e($fila->id); ?>">
                                                  <i class="fa fa-edit"></i>
                                              </button>
                                              <?php echo $__env->make('modals.editarRolModals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endif; ?>
                                            
              
                                            <?php if(Auth::user()->accesoRuta('/rol/delete')): ?>    
                                                                                  
                                              <a class="btn btn-danger btn-sm"title="Eliminar el rol" href="<?php echo e(route('rol.delete', ['id' => $fila->id])); ?>" onclick="
...
<?php echo $__env->make('plantilla.plantillaDT', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Escritorio\Importante\Clientes\clinica nueva\clinicaNueva\resources\views/rol/index.blade.php ENDPATH**/ ?>