            ...
            <div class="modal-body">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="<?php echo e(route('medico.insert')); ?>" method="POST" role="form" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                ...
                                <?php if(Request::url() === env('APP_URL').'/orden_laboratorio/create'): ?>
...
<?php /**PATH D:\Escritorio\Importante\Clientes\clinica nueva\clinicaNueva\resources\views/modals/MedicoModals.blade.php ENDPATH**/ ?>