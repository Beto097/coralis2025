<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="editarPacienteModal<?php echo e($fila->id); ?>" aria-hidden="true" style="display: none;">
            ...
            <div class="modal-body">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="<?php echo e(route('paciente.save')); ?>" method="POST" role="form" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" id="txtCedulaOld" value="<?php echo e($fila->identificacion_paciente); ?>">
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12 col-xs-12" id="cedulaDiv">                                    
                                        ...
                                        <input type="text" class="form-control"  name="txtCedula" id="txtCedula2" placeholder="Ejemplo:8-888-8888"  onfocusout="validar2()"
                                            value="<?php echo e($fila->identificacion_paciente); ?>" required>
                                    ...
                                    <div class="form-group mb-30 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="radio radio-primary">
                                            <input type="radio" name="txtsexo" id="radio1-<?php echo e($fila->id); ?>" value="m" <?php if($fila->sexo_paciente=="m"): ?> checked <?php endif; ?> >
                                            <label for="radio1-<?php echo e($fila->id); ?>">
                                                Masculino
                                            </label>
                                        </div>
                                        <div class="radio radio-info">
                                            <input type="radio" name="txtsexo" id="radio2-<?php echo e($fila->id); ?>" value="f" <?php if($fila->sexo_paciente=="f"): ?> checked <?php endif; ?>  >
                                    ...
                                    <div class="form-group col-md-6 col-sm-12 col-xs-12">                                    
                                        ...
                                        <input type="text" class="form-control" id="inputnombre" placeholder="Ejemplo:Juan" name="txtnombre"
                                            value="<?php echo e($fila->nombre_paciente); ?>" required >
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 col-xs-12">                                    
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="inputapellido" placeholder="Ejemplo:Perez" name="txtapellido"
                                            value="<?php echo e($fila->apellido_paciente); ?>" required > 
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="date" class="form-control" id="inputfecnac" name="txtfecnac"
                                            value="<?php echo e($fila->fecha_nacimiento_paciente); ?>" required>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="inputtelefono" placeholder="Ejemplo:66666666" name="txttelefono" 
                                            value="<?php echo e($fila->telefono_paciente); ?>"  >
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="input-group mb-15"> <span class="input-group-addon">@</span>
                                            <input type="email" class="form-control" placeholder="Ejemplo:juan@gmail.com" 
                                               name="txtemail" value="<?php echo e($fila->email_paciente); ?>">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <label class="control-label mb-10 text-left">Comentarios</label>
                                        <textarea class="form-control form-control-sm" id="exampleFormControlTextarea1" name="txtComentario" rows="2"><?php echo e($fila->comentario_paciente); ?></textarea>
                                    </div>
...
<?php /**PATH D:\Escritorio\Importante\Clientes\clinica nueva\clinicaNueva\resources\views/modals/editarPacienteModals.blade.php ENDPATH**/ ?>